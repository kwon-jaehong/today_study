...
with mlflow.start_run() as run:
    ...
    num2label = {i:label for i,label in enumerate(list(set(label_list)))}
    lable2num = {label:i for i,label in enumerate(list(set(label_list)))}
    ...
    train_all_dataset = CustomDataset(all_df,TEXT,lable2num,train_transform)
