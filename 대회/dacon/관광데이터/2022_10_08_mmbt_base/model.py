...
class imageEmbeddings(nn.Module):
    def __init__(self,tokenizer,embeddings,drop_out_p):
...
class CustomModel(nn.Module):
    def __init__(self,tokenizer,num_cat3_classes,drop_out_p=0.3):
        ...
        # Image
        self.image_encoder = imageEmbeddings(tokenizer,self.transformer.embeddings,drop_out_p)
