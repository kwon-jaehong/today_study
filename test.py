...
import itertools
correct_list = ["aya", "ye", "woo", "ma"]
correct_dict =[]

for i in range(1,len(correct_list)):
    temp_list = list(itertools.permutations(correct_list,i+1))
    ...
    for j in temp_list:
        ...
        correct_dict.append(temp_str)
answer = 0
for diff in babbling:
    if diff in correct_dict:
        answer+=1
